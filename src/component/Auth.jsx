...
const Auth = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        // if signing up then store these data as well in the cookie
        if(isSignup){
        ...
        window.location.reload();  // we are reloading here so that the whole application reloads and it will set the auth token to true(in App.jsx) so that we won't hit auth again and we will go to our chats as a logged in user
